...
from models import Media, User, Location, Tag, Comment, Relationship, User_info, Location_info
...
class InstagramAPI(oauth2.OAuth2API):
    ...
    user_info = bind_method(
                path="/users/{user_id}",
                accepts_parameters=["user_id"],
                root_class=User_info,
                response_type="entry")
    ...
    location_info = bind_method(
                path="/locations/{location_id}",
                accepts_parameters=["location_id"],
                root_class=Location_info,
                response_type="entry")
